...
namespace SampleWebApiAspNetCore.Controllers.v1
{
    ...
    public class DrinksController : ControllerBase
    {
        ...
        {
            List<DrinkEntity> drinkItem = _drinkRepository.GetAll(queryParameters).ToList();
            ...
            var toReturn = drinkItem.Select(x => _linkService.ExpandSingleItem(x, x.Id, version));
        ...
        {
            DrinkEntity foodItem = _drinkRepository.GetSingle(id);
        ...
        public ActionResult<DrinkDto> UpdateDrink(ApiVersion version, int id, [FromBody] DrinkUpdateDto foodUpdateDto)
        {
            ...
            _mapper.Map(foodUpdateDto, existingDrinkItem);
